 ...
 * @source $URL: http://svn.geotools.org/tags/2.4.5/modules/plugin/shapefile/src/main/java/org/geotools/data/shapefile/shp/ShapeType.java $
 */
public final class ShapeType {
  ...
  /**
     * @method hasMeasure
     * @return boolean
     * @author Simion Greener, 28th February 2011, Original coding
     */
  public boolean hasMeasure() {
      return this.id == POINTM.id ||
             this.id == ARCM.id   ||
             this.id == POLYGONM.id ||
             this.id == MULTIPOINTM.id;
  }
  ...
  /**
     ...
     */
  public boolean hasZ() {
    return this.id == POINTZ.id ||
           this.id == ARCZ.id   ||
           this.id == POLYGONZ.id ||
           this.id == MULTIPOINTZ.id;
  }
  ...
  public boolean isMultiLineType() {
    return id % 10 == 6; 
  }
  ...
  public boolean isMultiPolygonType() {
    return id % 10 == 7; 
  }
