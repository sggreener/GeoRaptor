...
class OraGeom
{
  ...
  {
    return lrsDim == 0 && geomType == org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.POINT && point != null && elemInfo == null;
  }
...
public int startingOffset(int elemIndex)
   ...
   *
   * @param geom the geometry to compute the GEOM_TYPE for geom type code, if known, or UNKNOWN
   */
  static int geomType(Geometry geom) {
    if (geom == null) {
        return org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.UNKNOWN_GEOMETRY; 
    } else if (geom instanceof Point) {
        return org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.POINT;
    } else if (geom instanceof LineString) {
        return org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.LINE;
    } else if (geom instanceof Polygon) {
        return org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.POLYGON;
    } else if (geom instanceof MultiPoint) {
        return org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.MULTIPOINT;
    } else if (geom instanceof MultiLineString) {
        return org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.MULTILINE;
    } else if (geom instanceof MultiPolygon) {
        return org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.MULTIPOLYGON;
    } else if (geom instanceof GeometryCollection) {
        return org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.COLLECTION;
    }
    return org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.UNKNOWN_GEOMETRY; 
  }
