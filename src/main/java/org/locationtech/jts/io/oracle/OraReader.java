...
public class OraReader 
{
  ...
  Geometry read(OraGeom oraGeom) {
    ...
    case org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.LINE:
        return readLine(oraGeom, 0);
    case org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.POLYGON:
        return readPolygon(oraGeom, 0);
    case org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.MULTIPOINT:
        return readMultiPoint(oraGeom, 0);
    case org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.MULTILINE:
        return readMultiLine(oraGeom);
    case org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.MULTIPOLYGON:
        return readMultiPolygon(oraGeom);
    case org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.COLLECTION:
   ...
   */
    private GeometryCollection readCollection(OraGeom oraGeom) 
    {
      ...
      for (int i = 0; cont && i < nElem; i++) {
        ...
        case org.locationtech.jts.io.oracle.OraGeom.ETYPE.POINT:
            if (interpretation == org.locationtech.jts.io.oracle.OraGeom.INTERP.POINT) {
            ...
            break;
        case org.locationtech.jts.io.oracle.OraGeom.ETYPE.LINE:
            geom = readLine(oraGeom, i);
            break;
        case org.locationtech.jts.io.oracle.OraGeom.ETYPE.POLYGON:
        case org.locationtech.jts.io.oracle.OraGeom.ETYPE.POLYGON_EXTERIOR:
    ...
    private MultiPolygon readMultiPolygon(OraGeom oraGeom)
    {
      ...
      for (int i = 0; i < nElem; i++) {
        int etype = oraGeom.eType(i);
        if ((etype == org.locationtech.jts.io.oracle.OraGeom.ETYPE.POLYGON) || 
            (etype == org.locationtech.jts.io.oracle.OraGeom.ETYPE.POLYGON_EXTERIOR)) {
    ...
    private MultiLineString readMultiLine(OraGeom oraGeom) 
    {
      ...
      for (int i = 0; i < nElem; i++) {
        ...
        if (etype != org.locationtech.jts.io.oracle.OraGeom.ETYPE.LINE)
          break;
    ...
    private MultiPoint readMultiPoint(OraGeom oraGeom, int elemIndex) 
    {
       ...
       */
      if (oraGeom.geomType() == org.locationtech.jts.io.oracle.OraGeom.GEOM_TYPE.MULTIPOINT) {
        ...
        checkETYPE(etype, org.locationtech.jts.io.oracle.OraGeom.ETYPE.POINT, "MultiPoint");
    ...
    private Polygon readPolygon(OraGeom oraGeom, int elemIndex) 
    {
      ...
      checkETYPE(etype, 
    		     org.locationtech.jts.io.oracle.OraGeom.ETYPE.POLYGON, 
                 org.locationtech.jts.io.oracle.OraGeom.ETYPE.POLYGON_EXTERIOR, 
                 "Polygon");
      
      checkInterpretation(interpretation, 
                          org.locationtech.jts.io.oracle.OraGeom.INTERP.POLYGON, 
                          org.locationtech.jts.io.oracle.OraGeom.INTERP.RECTANGLE, 
                          "Polygon");
      ...
      for (int i = elemIndex + 1; i < nElem; i++) {
        ...
        if (etype == org.locationtech.jts.io.oracle.OraGeom.ETYPE.POLYGON_INTERIOR) {
          holeRings.add(readLinearRing(oraGeom, i));
        } 
        else if (etype == org.locationtech.jts.io.oracle.OraGeom.ETYPE.POLYGON) { 
    ...
    private LinearRing readLinearRing(OraGeom oraGeom, int elemIndex) 
    {
      ...
      LinearRing ring;
      if (interpretation == org.locationtech.jts.io.oracle.OraGeom.INTERP.POLYGON) {
  ...
  private LineString readLine(OraGeom oraGeom, int elemIndex)
  {
    ...
    int interpretation = oraGeom.interpretation(elemIndex);
  	...
  	checkETYPE(etype, 
  			   org.locationtech.jts.io.oracle.OraGeom.ETYPE.LINE, 
  			   "LineString");
  	checkInterpretation(interpretation, 
  			            org.locationtech.jts.io.oracle.OraGeom.INTERP.LINESTRING, 
  			            "LineString");
