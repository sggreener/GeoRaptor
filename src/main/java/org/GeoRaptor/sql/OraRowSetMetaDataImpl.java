...
public class OraRowSetMetaDataImpl implements RowSetMetaData {
  ...
  public String getColumnClassName(int columnIndex) throws SQLException {
      ...
      case Types.DATE:          className = (new java.sql.Date(123456)).getClass().getName (); break;
      case Types.TIME:          className = (new java.sql.Time(123456)).getClass().getName (); break;
      case Types.TIMESTAMP:     className = (new java.sql.Timestamp(123456)).getClass().getName (); break;
      case Types.BLOB: byte[] blob = {}; className = (blob.getClass()).getName(); break;
      case Types.NCLOB :
      case Types.CLOB: char[] c = {};    className = (c.getClass()).getName(); break;
      case OracleTypes.ARRAY         : className = "oracle.sql.ARRAY"; break;
      case OracleTypes.BINARY_DOUBLE : className = (new oracle.sql.BINARY_DOUBLE(123456)).getClass().getName (); break;
      case OracleTypes.BINARY_FLOAT  : className = (new oracle.sql.BINARY_FLOAT(123456)).getClass().getName (); break;
  ...
  private class ColInfo implements Serializable 
  {
	  ...
	  private static final long serialVersionUID = 4067358039992818967L;
