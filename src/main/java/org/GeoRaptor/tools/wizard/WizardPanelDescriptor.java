...
public class WizardPanelDescriptor {
    ...
    /**
     * This enables access to a main data/procesing class instance that can be executed with the FINISH button of the last page
     * @param _writerObject
     * @method setWriterObject
     * @author Simon Greener, February 9th, 2011
     */
     private Object writerObject; 
     public void setWriterObject(Object _writerObject) {
         this.writerObject = _writerObject;
     }
    ...
    /**
     * A hack to allow for exchange of attributes between screens (I don't know how else to do this).
     * @author Simon Greener
     * @method setPreviousDescriptor
     * @author February 8th 2011, Original coding
     */
    public void setPreviousDescriptor(WizardPanelDescriptor _descriptor) {
    }
