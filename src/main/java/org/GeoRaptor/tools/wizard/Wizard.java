...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
   ...
   /**
    ...
    private void initComponents() {
        ...
        backButton = new JButton(new ImageIcon("org/GeoRaptor/tools/wizard/backIcon.gif"));
    ...
    private static Object getImage(String name) 
    {
        URL url = null;
        try {
            Class<?> c = Class.forName("org.GeoRaptor.tools.wizard.Wizard");
  ...
  static {
      ...
      try { 
          PropertyResourceBundle resources = (PropertyResourceBundle)
              ResourceBundle.getBundle("org.GeoRaptor.tools.wizard.Wizard");
