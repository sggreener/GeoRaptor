           ...
           Serializable 
{
  ...
  public void setOrdinate(int ordinateIndex, double value)
  {
    ...
    public void setX(double _x) {
        this.setOrdinate(X,_x);
    }
    
    public void setY(double _y) {
        this.setOrdinate(Y,_y);
    }
    
    public void setZ(double _z){
        this.setOrdinate(Z,_z);
    }
    
    public void setM(double _m) {
        this.setOrdinate(M,_m);
    }
    ...
    public void setLocation(double _x, double _y, double _z, double _m) {
        this.setOrdinate(X,_x);
        this.setOrdinate(Y,_y);
        this.setOrdinate(Z,_z); 
        this.setOrdinate(M,_m); 
    }
    public void setLocation(Coordinate _coord) {
        this.setOrdinate(X,_coord.x);
        this.setOrdinate(Y,_coord.y);
        this.setOrdinate(Z,_coord.z); 
        this.setOrdinate(M,_coord.m); 
    }
